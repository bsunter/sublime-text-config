...
## v. <a name="easymotion"></a> [EasyMotion](https://github.com/tednaleid/sublime-EasyMotion)
...
## xi. <a name="solarized_color_scheme"></a> [Solarized Color Scheme](https://github.com/SublimeColors/Solarized)
